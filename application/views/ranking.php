...
echo '<li><a href="http://localhost/haxeon2/ranking/index/day/'.$order.'/'.$cur_page.'/">1日</a></li>';
echo '<li><a href="http://localhost/haxeon2/ranking/index/week/'.$order.'/'.$cur_page.'/">1週間</a></li>';
echo '<li><a href="http://localhost/haxeon2/ranking/index/all/'.$order.'/'.$cur_page.'/">すべて</a></li>';
echo '</ul>';
...
echo '<li><a href="http://localhost/haxeon2/ranking/index/'.$days.'/pv/'.$cur_page.'/">閲覧数</a></li>';
echo '<li><a href="http://localhost/haxeon2/ranking/index/'.$days.'/fork/'.$cur_page.'/">フォーク数</a></li>';
echo '<li><a href="http://localhost/haxeon2/ranking/index/'.$days.'/pv/'.$cur_page.'/">お気に入り数</a></li>';
echo '</ul>';
...
echo '<li><a href="http://localhost/haxeon2/ranking/index/'.$days.'/pv/'.$cur_page.'/">15個</a></li>';
echo '<li><a href="http://localhost/haxeon2/ranking/index/'.$days.'/fork/'.$cur_page.'/">30個</a></li>';
echo '<li><a href="http://localhost/haxeon2/ranking/index/'.$days.'/pv/'.$cur_page.'/">100個</a></li>';
echo '</ul>';
